...
function NotifyStatusShipped($UserEmail, $UserName, $ProductNames, $TrackingNumbers)
{
    ...
    try {
        ...
        <body>
            <div class='container'>
                <h1>Order Shipped</h1>
                <p>Hello $UserName,</p>
                <p>We are excited to inform you that your order(s) have been shipped. Below are the tracking information:</p>
        ";
