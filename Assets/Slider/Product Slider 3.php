<head>
    <?php
    include_once $base_url . 'Assets/PHP/Configuration/Product Slider 3 Config.php';
    ?>
</head>
        ...
        <div class="swiper-wrapper">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($AddedInWishlist == 'Not Added') {
                    echo "<i class='bx bx-heart AddToWishlist AddToWishlist-3' data-product-id-wishlist='" . $row['ID'] . "'></i>";
                } else if ($AddedInWishlist == 'Added') {
                    echo "<i class='bx bxs-heart AddToWishlist AddToWishlist-3' data-product-id-wishlist='" . $row['ID'] . "'></i>";
                }
                ...
                if ($AddedInCart == 'Not Added') {
                    echo "<i class='bx bx-cart product-cart AddToCart-3' data-product-id='" . $row['ID'] . "'></i>";
                } else if ($AddedInCart == 'Added') {
                    echo "<i class='bx bx-check product-cart AddToCart-3' data-product-id='" . $row['ID'] . "'></i>";
                }
                echo "</div>";
                echo "</div>";
                echo "</div>";
