                ...
                <span id="SubTotal" data-cart-shipping-price="<?php echo $CartShippeingPrice ?>">Rs. <?php echo $TotalSaved; ?>.00</span>
                    ...
                    <div class="grid gap-2">
                        ...
                        <div class="grid gap-2" id='shippingOptions'>
                            ...
                            <label class="text-sm font-medium flex items-center justify-between rounded-md border border-muted px-4 py-3 cursor-pointer" for="Collect-From-Lazimpat">
                                <div class="flex items-center justify-center gap-2">
                                    <input type="checkbox" class="mt-[-2px]" id="Collect-From-Lazimpat" name='Shipping-rate'></input>
                                    Collect From Lazimpat
                                </div>
                                <span>Rs. 0</span>
                            </label>
                        </div>
