...
include_once $base_url . "Assets/PHP/Configuration/View More Product Config.php";
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="brand-heading-box">
        ...
        <div class="option-container">
            <div class="option-tag">
               ...
               <ul class="options" data-producttypeid="0" data-brandid="0" data-featuredproduct="<?php echo $featuredproduct; ?>">
