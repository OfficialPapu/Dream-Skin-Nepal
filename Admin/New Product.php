            ...
            <form action="#" enctype="multipart/form-data" id="formdata">
                ...
                <div class="product-id-and-quantity">
                    ...
                    <div class="product-quanttiy">
                        ...
                        <input type="text" name="ProductQuantity" id="ProductQuantity" placeholder="Product Quantity" value="">
                    </div>
                </div>
                ...
                <div class="price-plaining">
                    ...
                    <div class="discount-percentage">
                        ...
                        <input type="text" id="DiscountPercentage" name="DiscountPercentage" placeholder="Discount percentage" value='10'>
                    </div>
                </div>
